...
- `manifests/source_roots_probe.json`
...
- `orchestration/results/PH0-SOURCE-UPDATE-AUDIT.json`
...
- `evals/runs/`
- `evals/references/`
- any file outside this workspace other than the shallow source-root existence
  check above.

Completion criteria:

- write schema-valid JSON matching `schemas/child_result.schema.json`;
- audit D-0003 source-root approval, read-only inventory outputs, test output,
  generator-eligibility fail-closed posture, and no-baseline boundary;
